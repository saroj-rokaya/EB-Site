      ...
      <div className="rounded shadow-lg border bg-gray-50 hover:scale-105 duration-300 sm:w-1/3 md:w-1/4">
          ...
          <div className="p-2 ">
            ...
            <div className="sm:flex gap-2">
              <button className="mt-2 mr-1 w-[100px] px-3 py-1 bg-[#5AE4A8] border-2 border-[#5AE4A8] text-white hover:bg-white hover:text-[#5AE4A8] font-semibold rounded-md duration-300">
                Purchase
              </button>
