...
const reviews = [
    {
        name: "Paras Dhami",
        course: "Core Python",
        body: "I recently completed Python course with EB-Skills, and it was an outstanding experience. The course was well-organized, and the instructor made complex concepts easy to grasp. The hands-on exercises were particularly useful in reinforcing my understanding. I now feel much more confident in my Python programming skills. Thank you, EB-Skills! - Roshan Kumal",
        img: "https://avatar.vercel.sh/jack",
    },
    {
        name: "Suraj Siwakoti",
        course: "React JS Course",
        body: "I recently completed the React JS course with EB-Skills and I couldn't be happier with my experience. The course was well-organized and the instructor made everything easy to understand. The practical projects were great for hands-on learning. I feel much more confident in my React skills now. Thank you, EB-Skills!",
        img: "https://avatar.vercel.sh/jill",
    },
    {
        name: "Nawaraj Adhikari",
        course: "Frontend Development",
        body: "I recently completed the 3-month web development course with EB-Skills, and it was fantastic. The course was well-organized, and the instructors made complex topics easy to understand. The hands-on projects were really helpful in building my skills. I now feel much more confident in my web development abilities. Thank you, EB-Skills! - Suraj Thapa",
        img: "https://avatar.vercel.sh/john",
    },
    {
        name: "Roshan Thapa",
        course: "Flutter Development",
        body: "I recently completed the 1-month Flutter development course with EB-Skills, and it was an excellent experience. The course was well-structured, and the instructor explained everything in simple, easy-to-understand language. The hands-on projects were very helpful in solidifying my knowledge. I now feel much more confident in my Flutter development skills. Thank you, EB-Skills! - Roshani Thapa",
        ...
        >
            <div className="flex flex-row w-full py-2 items-center gap-2">
                ...
                <div className="flex flex-col">
                    ...
                    <p className="text-lg font-medium dark:text-white/40">{course}</p>
                </div>
            </div>
            <blockquote className="mt-2 text-md text-justify">{body}</blockquote>
        </figure>
    );
};
