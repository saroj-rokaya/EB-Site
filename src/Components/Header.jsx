...
const Header = () => {
  ...
  return (
    <nav className="sticky top-0 dark-back z-[99] px-10 mx-auto h-[10vh] p-2 flex justify-between items-center">
      <Link to="/">
      ...
      {toggle ? (
        <AiOutlineClose
          ...
          className="md:hidden text-2xl font-bold block light-text cursor-pointer"
        />
      ) : (
        <AiOutlineMenu
          onClick={() => setToggle(!toggle)}
      ...
      {/* //responsive menu */}
      <ul
        className={`md:hidden fixed dark-back backdrop-blur-3xl flex flex-col gap-5  top-[10vh] 
